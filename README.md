...
## 📌 프로젝트 소개
Scentype(씬타입)은 복잡한 향수 선택을 성격 유형(MBTI) 기반으로 쉽고 재미있게 풀어낸 웹 서비스입니다. 
딱딱한 심리 검사가 아닌 일상적인 12가지 감성 질문을 통해 사용자의 향 계열(플로럴, 우디, 시트러스, 오리엔탈, 머스크)을 분석하고, 그에 완벽하게 어울리는 퍼스널 향수를 추천해 드립니다.

* **배포 링크:** [https://codusnee.github.io/scentype/]
...
<br>
20246060 공공인재학부 노유빈 : [MBTI 16가지 유형별 향수 매칭 시나리오 기획 및 향수 매핑 recommend.html 제작, AI 에셋 제작, 향수 DB 수집]
